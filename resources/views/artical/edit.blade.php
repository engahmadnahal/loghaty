                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="title_ar" class="form-control" placeholder="{{__('dash.title_ar')}}"  value="{{$artical->title_ar}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <input type="text" id="title_en" class="form-control" placeholder="{{__('dash.title_en')}}"  value="{{$artical->title_en}}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <textarea type="text" id="body_ar" class="form-control" placeholder="{{__('dash.artical_ar')}}"  >{{  $artical->body_ar }}</textarea>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-label-group">
                                            <textarea type="text" id="body_en" class="form-control" placeholder="{{__('dash.artical_en')}}"  >{{  $artical->body_en }}</textarea>
...
<script>
    ...
    function performUpdate(){
        ...
        performUpdateWithTostar('/articals/{{$artical->id}}',dataObj);
    }
</script>
@endsection