                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-label-group">
                                                                <input type="text" id="option_foure_ar" class="form-control" placeholder="{{__('dash.option_foure_ar')}}"  value="{{$qs->option_foure_ar}}">
                                                                <label for="option_foure_ar">{{__('dash.option_foure_ar')}}</label>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-label-group">
                                                                    <input type="text" id="option_foure_en" class="form-control" placeholder="{{__('dash.option_foure_en')}}"  value="{{$qs->option_foure_en}}">
                                                                    <label for="option_foure_en">{{__('dash.option_foure_en')}}</label>
                                                                </div>
                                                            </div>
...
<script>
    function performUpdate(){
        ...
        let option_foure_ar = document.getElementById('option_foure_ar').value;
        let option_foure_en = document.getElementById('option_foure_en').value;
        ...
        formData.append('option_foure_ar',option_foure_ar);
        formData.append('option_foure_en',option_foure_en);
        ...
        performUpdateWithTostar('/qs_playings/{{$qs->id}}',formData);
    }
</script>
@endsection