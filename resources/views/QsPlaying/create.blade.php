                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-label-group">
                                                                <input type="text" id="option_foure_ar" class="form-control" placeholder="{{__('dash.option_foure_ar')}}"  required>
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-label-group">
                                                                    <input type="text" id="option_foure_en" class="form-control" placeholder="{{__('dash.option_foure_en')}}"  required>
...
<script>
    function performStore(){
        ...
        performStoreWithTostar('/qs_playings',formData,'form');
    }
</script>
@endsection