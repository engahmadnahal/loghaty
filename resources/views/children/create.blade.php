                        ...
                        <form class="form" id="form">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="date" id="dob" class="form-control" placeholder="{{__('dash.dob')}}" >
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            ...
                                            <select class="select2 form-control select2-hidden-accessible" data-select2-id="2" tabindex="-1" aria-hidden="true" id="class_id">
...
<script>
    function performStore(){
        ...
        performStoreWithTostar('/childrens',formData,'form');
    }
</script>
@endsection